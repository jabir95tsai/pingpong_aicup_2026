...
> 學生組團隊專案（隊伍 TEAM_10220）。團隊人數：[待補充：團隊人數]。我的角色：[待補充：例如「模型與集成負責人」]。
...
> [待補充：請確認上述哪些為「我個人完成」、哪些為「與組員協作」，以精準區分團隊與個人貢獻]
...
- **GitHub Repo**：https://github.com/jabir95tsai/pingpong_aicup_2026 ｜ [待補充：目前為私有，求職用途請確認是否開放權限或設為公開]
- **發表簡報**：[待補充：簡報連結（目前為本機 PDF，未上線）]
- **競賽官網**：[待補充：AI CUP 2026 競賽連結]

---

<!--
═══════════════════════════════════════════════
待補充清單（請回頭補齊，勿讓佔位符進入正式版）：
1. [待補充：團隊人數]
2. [待補充：我的角色定位，例如「模型與集成負責人」]
3. [待補充：確認個人 vs 團隊協作的分工，避免過度歸功]
4. [待補充：作者姓名 / 聯絡方式（求職用）]
5. [待補充：GitHub repo 目前為私有，是否設為公開或開放權限給招募方]
6. [待補充：發表簡報的可分享連結]
7. [待補充：AI CUP 2026 競賽官網連結]
8. （可選）[待補充：主辦單位全名與賽事日期，目前僅知 2026 年]
═══════════════════════════════════════════════
-->
