...
EXPECTED_AUG_PAIRS = 2353   # feature rows generated by is_train=True
...
def main():
    ...
    if aug_path is None:
        ...
        aug_path = os.path.join(data_dir, "test_history_pairs.parquet")
    ...
    print(f"  flip={use_flip}  folds={n_folds}  n_boost={n_boost}  "
          f"stack={use_stack}  skip_cb={skip_cb}  es={es_rounds}")
