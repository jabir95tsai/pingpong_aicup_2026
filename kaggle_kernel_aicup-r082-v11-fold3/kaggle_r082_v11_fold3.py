# # R-082 Phase 2 split — V11 train fold 3 only (--fold-only 3)
#
...
# fold 3, producing models/v11_fold3.pt.
...
t0 = time.time()
log_path = OUT_DIR / "logs" / "r082_v11_fold3.log"
